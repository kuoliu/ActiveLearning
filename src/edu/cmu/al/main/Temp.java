...
//		SqlManipulation.update(sql);
	...
	public static void fun2() {
		String sql = "alter table product_feature add column f11 real";
		SqlManipulation.update(sql);
		sql = "alter table product_feature add column f12 real";
		SqlManipulation.update(sql);
		sql = "alter table product_feature add column f13 real";
		SqlManipulation.update(sql);
	}
