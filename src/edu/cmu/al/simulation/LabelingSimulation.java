 ...
 * 
 *         The LabelingInterface interface is used to select instances from the
 *         prediction result, label a certain number of instances and send back
 *         the result. The interface can simulate the user's behavior, and label
 *         instances.
 */
